...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-08-2025 a las 21:49:53
...
('010030', '1', '7', 'Patch Panel', 'Nuevo', 'V-30587785', '1', 1);
...
CREATE TABLE `componente_atendido` (
  ...
  `observación` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('V-30266398', 'Leizer', 'Torrealba', '1', '1', '1', '0416-0506544', 'leizeraponte2020@gmail.com', 1),
...
('1', 'Gobernación', '', '', '', 'interno', 0),
('3', 'Teatro Juaréz', 'Carrera 19', '0251-0070551', 'Renato Contreras', 'Interno', 1),
...
('61', '180', '1', NULL, 'V-30266398', NULL, NULL, NULL, 'A');
...
INSERT INTO `switch` (`codigo_bien`, `serial`, `cantidad_puertos`) VALUES
('0008', '12234', 52);
...
('1', 'Soporte Técnico', 'V-30266398', 1),
('2', 'Redes', 'V-30266398', 1),
('3', 'Telefonía', NULL, 1),

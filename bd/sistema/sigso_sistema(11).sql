...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2025 a las 17:01:58
...
(10, 128, 1, NULL, NULL, '0000-00-00 00:00:00', NULL, NULL, '1'),
(11, 129, 1, NULL, NULL, '0000-00-00 00:00:00', NULL, NULL, '1');
...
(123, 'V-1234567', 'muvi', 2, '2025-06-25 09:51:15', 'Pendiente', NULL, 1),
...
(127, 'V-1234567', 'sada', 2, '2025-06-25 10:18:43', 'Pendiente', NULL, 1),
(128, 'V-1234567', 'hoja', 2, '2025-06-25 10:24:37', 'Pendiente', NULL, 1),
(129, 'V-31843937', 'Mentira se llama jorge c', NULL, '2025-06-25 10:29:39', 'Pendiente', NULL, 1);
...
--
ALTER TABLE `hoja_servicio`
  MODIFY `codigo_hoja_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `solicitud`
  MODIFY `nro_solicitud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;

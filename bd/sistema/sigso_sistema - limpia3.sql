...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2025 a las 03:10:05
...
CREATE TABLE `bien` (
  ...
  `id_marca` varchar(24) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `descripcion` varchar(100) DEFAULT NULL,
  `estado` varchar(45) NOT NULL,
  `cedula_empleado` varchar(12) DEFAULT NULL,
  `id_oficina` varchar(24) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
('10002201', 'ELECT4882025100923103488', 'INTEL1332025100923105633', 'Laptop Gaming', 'Nuevo', 'V-30266398', 'OFICIPIS2025101419103834', 1);
...
('ENCAR0022025100112011321', 'Encargado', 1),
('SECRE5062025100923102506', 'Secretario', 1),
('TECNI0012025100112013227', 'Técnico', 1);
...
CREATE TABLE `categoria` (
  ...
  `id_tipo_servicio` varchar(24) DEFAULT NULL,
  `estatus` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('ELECT4882025100923103488', 'Electrónico', 'SOPOR6432025101300104143', 1),
('MUEBL9812025100923103181', 'Móvil', 'SOPOR6432025101300104143', 1);
...
CREATE TABLE `componente` (
  ...
  `id_tipo_servicio` varchar(24) NOT NULL,
...
INSERT INTO `componente` (`id`, `id_tipo_servicio`, `nombre`, `prefijo`, `bool_texto`, `estatus`) VALUES
('ELECTFIL2025101321101573', 'ELECT4322025101321101432', 'Filtros Cambiados', 'Cantidad', 1, 1),
('ELECTREB2025101321101569', 'ELECT4322025101321101432', 'Reballing de Chip Gráfico', NULL, 0, 1),
('ELECTREP2025101321101579', 'ELECT4322025101321101432', 'Reparación de Pistas', 'Componente', 1, 1),
('SOPORCAM2025101300104234', 'SOPOR6432025101300104143', 'Cambio de Disco Duro', 'Capacidad', 1, 1),
('SOPORCAM2025101300104237', 'SOPOR6432025101300104143', 'Cambio de Memoria RAM', 'Capacidad', 1, 1);
...
CREATE TABLE `componente_atendido` (
  `id` varchar(24) NOT NULL,
  `id_componente` varchar(24) NOT NULL,
  `id_hoja_servicio` varchar(24) NOT NULL,
...
('SOPORHS52025101421102234', 'SOPORCAM2025101300104234', 'HS512025101420102517', 1, '256 GB'),
('SOPORHS52025101421102245', 'SOPORCAM2025101300104237', 'HS512025101420102517', 1, '4GB x 2');
...
('GOBERSEC2025100717100438', 'GOBER0012025100112004001', 'Secretaría del Gobierno', 1),
('OFITIGOB2025100112004023', 'GOBER0012025100112004001', 'OFITIC', 1);
...
CREATE TABLE `detalle_hoja` (
  `id_detalle_` varchar(24) NOT NULL,
  `codigo_hoja_servicio` varchar(24) NOT NULL,
  `componente` varchar(100) DEFAULT NULL,
  `detalle` varchar(200) DEFAULT NULL,
  `id_movimiento_material` varchar(24) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `empleado` (
  ...
  `grado_experiencia_empleado` int(5) DEFAULT 0,
  `id_servicio` varchar(24) DEFAULT NULL,
  `id_unidad` varchar(24) NOT NULL,
...
INSERT INTO `empleado` (`cedula_empleado`, `nombre_empleado`, `apellido_empleado`, `id_cargo`, `grado_experiencia_empleado`, `id_servicio`, `id_unidad`, `telefono_empleado`, `correo_empleado`, `estatus`) VALUES
('V-00000000', 'root', 'admin', 'TECNI0012025100112013227', 5, NULL, 'SOPOROFI2025100112003079', '0000-0000000', 'prueba@gmail.com', 1),
('V-1244512', 'Alexandra', 'Andrade', 'SECRE5062025100923102506', 0, NULL, 'RECEPGOB2025100922101221', '0414-1050657', 'aleee1234_12@gmail.com', 1),
('V-30266398', 'Leizer Gabriel', 'Torrealba Aponte', 'ENCAR0022025100112011321', 0, NULL, 'SOPOROFI2025100112003079', '0416-0506544', 'leizeraponte2020@gmail.com', 1);
...
('GOBER0012025100112004001', 'Gobernacion', 'Carrera 19 con calle 22', '0424-0031453', 'Yannis Aguero', 'Interno', 1),
('TEATR0022025100112004001', 'Teatro Juarez', 'Carrera 19 con calle 50', '0416-0506513', 'Carlos Mujica', 'Externo', 1);
...
('LAPTO6382025101419102138', 'Laptop', '20200-LKP', '10002201', 'SOPOROFI2025100112003079', 1);
...
CREATE TABLE `hoja_servicio` (
  `codigo_hoja_servicio` varchar(24) NOT NULL,
  `nro_solicitud` varchar(24) NOT NULL,
  `id_tipo_servicio` varchar(24) NOT NULL,
  `redireccion` varchar(24) DEFAULT NULL,
...
('HS512025101420102517', 'PRNO2025101420102551', 'SOPOR6432025101300104143', NULL, 'V-30266398', NULL, '', '', 'A');
...
CREATE TABLE `interconexion` (
  `id_interconexion` varchar(24) NOT NULL,
...
('GENRI1892025100923102989', 'Genérica', 1),
('INTEL1332025100923105633', 'Intel', 1),
('NETGE3492025100923104549', 'NetGeo', 1),
('OPPO0402025100923103740', 'OPPO', 1);
...
CREATE TABLE `material` (
  `id_material` varchar(24) NOT NULL,
  `ubicacion` varchar(24) DEFAULT NULL,
...
CREATE TABLE `movimiento_materiales` (
  `id_movimiento_material` varchar(24) NOT NULL,
  `id_material` varchar(24) NOT NULL,
...
CREATE TABLE `oficina` (
  `id_oficina` varchar(24) NOT NULL,
  `id_piso` varchar(24) NOT NULL,
...
('OFICIPIS2025101419103834', 'PISO9462025101419100946', 'Oficina 5', 1),
('OFICIPIS2025101419105140', 'PISO9462025101419100946', 'Oficina 4', 1);
...
('PISO0092025101419102309', 'Piso', '2', 1),
('PISO9462025101419100946', 'Piso', '1', 1);
...
('ELECTCOR2025101321101455', 'ELECT4322025101321101432', 'Corrección de Corto Circuito', 1, 'Componente', 1),
('ELECTREP2025101321101447', 'ELECT4322025101321101432', 'Reparación de Fuente de Poder', 0, NULL, 1),
('ELECTREP2025101321101452', 'ELECT4322025101321101432', 'Reparación de Pantalla', 0, NULL, 1),
('SOPORCAM2025101300104105', 'SOPOR6432025101300104143', 'Cambio de Pasta Térmica', 1, 'Cantidad', 1),
('SOPORINS2025101300104225', 'SOPOR6432025101300104143', 'Instalación de OFFICE', 1, 'Versión', 1);
...
CREATE TABLE `servicio_realizado` (
  `id_servicio_realizado` varchar(24) NOT NULL,
  `id_servicio_prestado` varchar(24) NOT NULL,
  `id_hoja_servicio` varchar(24) NOT NULL,
  `estado` int(1) NOT NULL DEFAULT 0,
  `observacion` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('SOPORHS52025101421102124', 'SOPORINS2025101300104225', 'HS512025101420102517', 1, '2020'),
('SOPORHS52025101421102125', 'SOPORCAM2025101300104105', 'HS512025101420102517', 0, NULL);
...
CREATE TABLE `solicitud` (
  ...
  `id_equipo` varchar(24) DEFAULT NULL,
  `nivel_complejidad` int(1) DEFAULT 0,
...
INSERT INTO `solicitud` (`nro_solicitud`, `cedula_solicitante`, `motivo`, `id_equipo`, `nivel_complejidad`, `fecha_solicitud`, `estado_solicitud`, `resultado_solicitud`, `estatus`) VALUES
('PRNO2025101420102551', 'V-30266398', 'No enciende', 'LAPTO6382025101419102138', 0, '2025-10-14 20:00:25', 'En proceso', NULL, 1);
...
('ELECT4322025101321101432', 'Electrónica', 'V-30266398', 1),
('SOPOR6432025101300104143', 'Soporte Técnico', 'V-30266398', 1);
...
CREATE TABLE `unidad` (
  `id_unidad` varchar(24) NOT NULL,
  `id_dependencia` varchar(24) NOT NULL,
...
('RECEPGOB2025100922101221', 'GOBERSEC2025100717100438', 'Recepcion', 1),
('REDESOFI2025100718102941', 'OFITIGOB2025100112004023', 'Redes', 1),
('SOPOROFI2025100112003079', 'OFITIGOB2025100112004023', 'Soporte Técnico', 1);
...
`id_detalle_` varchar(24)
,`codigo_hoja_servicio` varchar(24)
,`componente` varchar(100)
,`detalle` varchar(200)
,`id_movimiento_material` varchar(24)
,`id_material` varchar(24)
,`cantidad` int(11)
...
`codigo_hoja_servicio` varchar(24)
,`nro_solicitud` varchar(24)
,`id_tipo_servicio` varchar(24)
,`nombre_tipo_servicio` varchar(45)
,`redireccion` varchar(24)

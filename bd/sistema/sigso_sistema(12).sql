...
--
-- Host: localhost:3306
-- Generation Time: Jun 27, 2025 at 02:23 PM
...
('V-31843937', 'Jorge', 'Cabrera', 1, 1, 1, '0424-5567016', 'cabrerajorge2003@gmail.com');
...
(10, 128, 1, NULL, 'V-31843937', '0000-00-00 00:00:00', NULL, NULL, 'A'),
(11, 129, 1, NULL, 'V-31843937', '0000-00-00 00:00:00', NULL, NULL, 'A'),
(12, 131, 1, NULL, NULL, '2025-06-27 10:07:11', NULL, NULL, 'A'),
(13, 130, 1, NULL, NULL, '2025-06-27 10:08:08', NULL, NULL, 'A'),
(14, 127, 1, NULL, NULL, '2025-06-27 10:08:19', NULL, NULL, 'A'),
(15, 123, 2, NULL, NULL, NULL, NULL, NULL, 'A');
...
CREATE TABLE `patch_panel` (
  `codigo_bien` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `serial` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
(108, 'V-30266398', 'Prueba registrosos', 2, '2025-06-24 19:25:58', 'Pendiente', NULL, 0),
...
(123, 'V-1234567', 'muvi', 2, '2025-06-25 09:51:15', 'En proceso', NULL, 1),
(124, 'V-21140325', 'asdf', 2, '2025-06-25 09:54:09', 'Pendiente', NULL, 1),
(125, 'V-30587785', 'asd3', 2, '2025-06-25 09:56:00', 'Pendiente', NULL, 1),
(126, 'V-1234567', 'hola', 2, '2025-06-25 10:16:36', 'Pendiente', NULL, 1),
(127, 'V-1234567', 'Necesita mas ram a su equipo', 2, '2025-06-25 10:18:43', 'En proceso', NULL, 1),
(128, 'V-1234567', 'hoja', 2, '2025-06-25 10:24:37', 'En proceso', NULL, 1),
(129, 'V-31843937', 'Mentira se llama jorge c', NULL, '2025-06-25 10:29:39', 'En proceso', NULL, 1),
(130, 'V-30266398', 'Necesita un monitos LCTRCs', 2, '2025-06-27 10:05:26', 'En proceso', NULL, 1),
(131, 'V-30266398', 'Necesita un monitor LCRCT', NULL, '2025-06-27 10:07:11', 'En proceso', NULL, 1);
...
--
ALTER TABLE `hoja_servicio`
  MODIFY `codigo_hoja_servicio` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `material`
  MODIFY `id_material` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `oficina`
  MODIFY `id_oficina` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `solicitud`
  MODIFY `nro_solicitud` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
...
--
ALTER TABLE `unidad`
  MODIFY `id_unidad` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `patch_panel`
--
ALTER TABLE `patch_panel`

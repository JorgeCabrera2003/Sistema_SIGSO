...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2025 a las 22:39:41
...
-- Procedimientos
--
DROP PROCEDURE IF EXISTS `obtener_tecnicos_por_servicio`$$
...
DROP PROCEDURE IF EXISTS `obtener_tecnico_porArea`$$
...
DROP PROCEDURE IF EXISTS `sp_crear_hoja_servicio`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_bienes`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_materiales_utilizados`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_movimientos_materiales`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_patch_panel`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_patch_panel_por_nro`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_rendimiento_tecnicos`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_solicitudes_atendidas`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_solicitudes_equipo`$$
...
DROP PROCEDURE IF EXISTS `sp_reporte_switches`$$
...
--
-- Truncar tablas antes de insertar `bien`
--
...
--
DROP TRIGGER IF EXISTS `tr_before_insert_detalle_hoja`;
DELIMITER $$
...
--
-- Truncar tablas antes de insertar `detalle_solicitud_compra`
--

TRUNCATE TABLE `detalle_solicitud_compra`;
-- --------------------------------------------------------
...
--
-- Truncar tablas antes de insertar `ente`
--
...
--
DROP VIEW IF EXISTS `filtrado_empleado`;
...
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `filtrado_hoja`;
...
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `filtrado_tecnico`;
...
--
DROP TRIGGER IF EXISTS `tr_after_insert_hoja_servicio`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `tr_after_update_hoja_servicio`;
DELIMITER $$
...
--
-- Truncar tablas antes de insertar `interconexion`
--
...
--
-- Truncar tablas antes de insertar `movimiento_materiales`
--
...
--
-- Truncar tablas antes de insertar `patch_panel`
--
...
--
-- Truncar tablas antes de insertar `punto_conexion`
--
...
--
-- Truncar tablas antes de insertar `servicio_prestado`
--

TRUNCATE TABLE `servicio_prestado`;
-- --------------------------------------------------------
...
--
-- Truncar tablas antes de insertar `servicio_realizado`
--
...
--
-- Truncar tablas antes de insertar `solicitud_compra`
--

TRUNCATE TABLE `solicitud_compra`;
-- --------------------------------------------------------
...
--
-- Truncar tablas antes de insertar `tipo_bien`
--
...
INSERT INTO `tipo_bien` (`id_tipo_bien`, `nombre_tipo_bien`, `id_tipo_servicio`, `estatus`) VALUES
...
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `vista_detalles_hoja`;
...
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `vista_hojas_servicio_completa`;
...
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `vista_hoja_servicio_completa`;
...
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `vista_reporte_hojas_servicio`;
...
--
ALTER TABLE `tipo_bien`
  ADD CONSTRAINT `tipo_bien_ibfk_1` FOREIGN KEY (`id_tipo_servicio`) REFERENCES `tipo_servicio` (`id_tipo_servicio`) ON DELETE CASCADE ON UPDATE CASCADE;

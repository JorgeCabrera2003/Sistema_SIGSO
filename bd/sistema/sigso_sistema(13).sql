...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2025 a las 16:03:07
...
--
ALTER TABLE `detalle_hoja`
  MODIFY `id_detalle_` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `hoja_servicio`
  MODIFY `codigo_hoja_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `solicitud`
  MODIFY `nro_solicitud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;

        ...
        <div class="mt-4 accordion" id="accordionPermisos">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingSeguridad">
              <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeguridad" aria-expanded="true" aria-controls="collapseSeguridad">
                Seguridad
              </button>
            </h2>
            <div id="collapseSeguridad" class="accordion-collapse collapse show" aria-labelledby="headingSeguridad" data-bs-parent="#accordionPermisos">
          ...
          <div class="accordion-item">
            ...
            <div id="collapsePersonal" class="accordion-collapse collapse" aria-labelledby="headingPersonal" data-bs-parent="#accordionPermisos">
              <div class="accordion-body">
                <div class="row">
                  <div class="col-md-6">
                    <!-- Grupo Empleado -->
          ...
          <div class="accordion-item">
            ...
            <div id="collapseSolicitudes" class="accordion-collapse collapse" aria-labelledby="headingSolicitudes" data-bs-parent="#accordionPermisos">
              <div class="accordion-body">
                <div class="row">
                  <div class="col-md-6">
                    <!-- Grupo Solicitud -->
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingOrganizacion">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOrganizacion" aria-expanded="false" aria-controls="collapseOrganizacion">
                Organización
              </button>
            </h2>
            <div id="collapseOrganizacion" class="accordion-collapse collapse" aria-labelledby="headingOrganizacion" data-bs-parent="#accordionPermisos">
              <div class="accordion-body">
                <div class="row">
                  <div class="col-md-6">
                    <!-- Grupo Ente -->
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingEquipos">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEquipos" aria-expanded="false" aria-controls="collapseEquipos">
                Equipos y Bienes
              </button>
            </h2>
            <div id="collapseEquipos" class="accordion-collapse collapse" aria-labelledby="headingEquipos" data-bs-parent="#accordionPermisos">
              <div class="accordion-body">
                <div class="row">
                  <div class="col-md-6">
                    <!-- Grupo Bien -->
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingInfraestructura">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseInfraestructura" aria-expanded="false" aria-controls="collapseInfraestructura">
                Infraestructura
              </button>
            </h2>
            <div id="collapseInfraestructura" class="accordion-collapse collapse" aria-labelledby="headingInfraestructura" data-bs-parent="#accordionPermisos">
              <div class="accordion-body">
                <div class="row">
                  <div class="col-md-6">
                    <!-- Grupo Switch -->

      ...
      <div class="modal-body">
        <form id="formEmpleado">
            ...
            <div class="col-sm-6">
              <div class="form-floating mb-3">
                <input placeholder="Cédula de Identidad" class="form-control" name="cedula" type="text" id="cedula"
                  maxlength="45" pattern="[0-9]{1,9}" title="Solo números, máximo 9 dígitos" required>
            ...
            <div class="col-md-6">
              <div class="form-floating mb-3">
                <input placeholder="Nombre" class="form-control" name="nombre" type="text" id="nombre" maxlength="45" 
                  pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]{2,}" title="Solo letras y espacios (mínimo 2 caracteres)" required>
          ...
          <div class="row justify-content-center" id="Fila3">
            <div class="col-md-4">
              <div class="form-floating mb-3">
                <input placeholder="Teléfono" class="form-control" name="telefono" type="text" id="telefono" maxlength="15"
                  pattern="\d{4}-\d{7}" title="Formato: 0412-1234567" required>

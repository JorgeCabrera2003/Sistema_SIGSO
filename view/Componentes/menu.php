...
.sidebar.collapsed .fa-angle-right {
...
document.addEventListener('DOMContentLoaded', function() {
    // 1. Auto-scroll al elemento activo al cargar la página
    const activeItem = document.querySelector('.menu-item.active');
    if (activeItem) {
        // Esperar un breve momento para que el DOM termine de renderizarse
        setTimeout(() => {
    ...
    // 2. Animación al desplegar submenús
    ...
    collapseButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Esperar a que Bootstrap complete la animación de colapso (300ms es la duración por defecto)
            setTimeout(() => {
    ...
    // 3. Manejar el estado colapsado/expandido del sidebar
    ...
    // Función para cargar el estado del sidebar

...
class ServicioPrestado extends Conexion
{
        ...
        if ($bool['bool'] == 0) {
            if ($boolServicio['bool'] == 1) {
                try {
                    ...
                    $query = "INSERT INTO servicio_prestado (id, id_tipo_servicio, nombre, prefijo, bool_texto, estatus)
    ...
    private function Actualizar()
    {
        ...
        if ($boolServicio['bool'] == 1) {
            ...
            try {
                ...
                $query = "UPDATE servicio_prestado SET nombre = :nombre, prefijo = :prefijo, bool_texto = :bool_texto WHERE id = :id";
    ...
    private function Consultar()
    {
        ...
        try {
            ...
            $this->conexion = $this->conexion->Conex();
            $this->conexion->beginTransaction();
            $query = "SELECT sp.id, sp.id_tipo_servicio, tp.nombre_tipo_servicio, sp.nombre, sp.prefijo, sp.bool_texto FROM servicio_prestado AS sp 
